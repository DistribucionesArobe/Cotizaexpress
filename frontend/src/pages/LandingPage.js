        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/contacto" className="text-slate-600 hover:text-emerald-600 font-medium hidden md:block">Contacto</Link>
              <Link to="/login">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="https://wa.me/528130850381?text=Hola%2C%20me%20interesa%20CotizaBot" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-green-400 flex items-center gap-2">
                ...
                <li><a href="mailto:contacto@arobegroup.com" className="text-slate-400 hover:text-white flex items-center gap-2">
